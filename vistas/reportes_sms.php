    ...
    <form class="form-inline" id="form_main">
		...
		<div class="form-group mr-1">
			<div class="input-group">				
				...
				<input type="date" required id="fecha_i" name="fecha_i" style="width:160px;" value="<?php echo date ("Y-m-d");?>" data-toggle="tooltip" data-placement="top" title="Fecha Inicial" class="form-control" />
			</div>
		</div>	  
		<div class="form-group mr-1">
			<div class="input-group">				
				...
				<input type="date" required id="fecha_f" name="fecha_f" style="width:160px;" value="<?php echo date ("Y-m-d");?>" data-toggle="tooltip" data-placement="top" title="Fecha Final" class="form-control"/>	
			</div>
		</div>		  
		<div class="form-group mr-1">
			<input type="text" placeholder="Buscar por: Exp, Nombre o Identidad" id="bs_regis" data-toggle="tooltip" data-placement="top" title="Buscar por: Expediente, Nombre, Apellido o Identidad" autofocus class="form-control" size="35"/>
		</div>
		<div class="form-group mr-1">
			<div class="input-group">				
				<div class="input-group-append">				
				...
				<select id="usuario" name="usuario" class="custom-select" data-toggle="tooltip" data-placement="top" title="Colaborador"> 
					<option value="">Seleccione</option>
				</select>
			</div>
		</div>	  
