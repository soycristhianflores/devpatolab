...
$query = "SELECT m.pacientes_id AS 'pacientes_id', CONCAT(p.nombre, ' ', p.apellido) As 'paciente', m.colaborador_id AS 'colaborador_id', CONCAT(c.nombre, ' ', c.apellido) As 'profesional', m.servicio_id AS 'servicio_id', m.fecha AS 'fecha', m.material_eviando AS 'material_eviando'
	FROM muestras AS m
