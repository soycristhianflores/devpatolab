...
$pacientes_id = $_POST['paciente_te'];
$fecha = $_POST['fecha'];
...
if($result_transito->num_rows==0){
	if($result_atencion->num_rows>=1){
		...
		$insert = "INSERT INTO transito_enviada 
			VALUES('$transito_id','$fecha','$atencion_id','$pacientes_id','$colaborador_id','$anos','$paciente','$enviada','$servicio_id','$motivo','$fecha_registro')";
