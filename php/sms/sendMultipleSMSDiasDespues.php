...
$where  = "WHERE a.servicio_id = '$servicio' AND CAST(a.fecha_cita AS DATE) = '$fecha' AND a.status = 0 AND LENGTH(p.telefono) = 8 AND p.telefono NOT LIKE '2%'";
$where1 = "WHERE a.servicio_id = '$servicio' AND CAST(a.fecha_cita AS DATE) = '$fecha' AND a.status = 0 AND LENGTH(p.telefono1) = 8 AND p.telefono1 NOT LIKE '2%'";
...
$query_consulta = "SELECT sms_id
   FROM sms
   WHERE fecha = '$fecha' AND servicio_id = '$servicio' AND dias = 5";
