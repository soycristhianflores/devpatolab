...
<div id="page_pdf">
	...
	<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th width="11.66%" class="textleft">Cantidad</th>
					<th width="11.66%" class="textright">Precio</th>
					<th width="11.66%" class="textright">Descuento</th>
					<th width="11.66%" class="textright">Importe</th>
				</tr>
			</thead>
	...
	<div>
		...
		<p class="nota"></p>
		<p class="nota">La factura es beneficio de todos "Exijala"</p>
