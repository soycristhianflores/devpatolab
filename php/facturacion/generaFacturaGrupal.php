...
$query_factura_detalle = "SELECT CONCAT(p.nombre, ' ', p.apellido) As 'cliente', m.material_eviando AS 'material_eviando', fd.cantidad AS 'cantidad', fd.importe AS 'importe', fd.isv_valor AS 'isv_valor', fd.descuento AS 'descuento', fd.facturas_id AS 'facturas_id', m.referencia AS 'referencia', m.muestras_id AS 'muestras_id'
