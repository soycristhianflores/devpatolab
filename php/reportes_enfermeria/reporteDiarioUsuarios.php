...
$fila=3;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", "Preclínica ".$servicio_name);
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:AG$fila"); //unir celdas
$objPHPExcel->getActiveSheet()->setSharedStyle($titulo, "A$fila:AG$fila");
...
// nombre del archivo
header('Content-Disposition: attachment; filename="REPORTE DIARIO '.strtoupper($servicio_name).' '.strtoupper($mes).'_'.$año.'.xls"');
//**********************************************************************
